...
rm -rf hepmc14.fifo  # delete existing pipes
rm -rf pythia14.log
rm -rf rivet14.log

mkfifo hepmc14.fifo  # initiate pipe

./main89 main89unlops1LHE14.cmnd hepmc14.fifo >> pythia14.log &
...
rivet hepmc14.fifo --event-timeout 172800 -a MC_ZKTSPLITTINGS -a MC_ZJETS -a MC_ZINC -a MC_XS -a MC_TAUS -a MC_PHOTONS -a MC_JETS -a MC_ELECTRONS -a CMS_2017_I1635889 -a CMS_2018_I1667854 -a CMS_2019_I1753680 -a CMS_2020_I1837084 -o dyee012j_5f_NLO_UNLOPS14.yoda &>> rivet14.log
