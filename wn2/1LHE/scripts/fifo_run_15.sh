...
rm -rf hepmc15.fifo  # delete existing pipes
rm -rf pythia15.log
rm -rf rivet15.log

mkfifo hepmc15.fifo  # initiate pipe

./main89 main89unlops1LHE15.cmnd hepmc15.fifo >> pythia15.log &
...
rivet hepmc15.fifo --event-timeout 172800 -a MC_ZKTSPLITTINGS -a MC_ZJETS -a MC_ZINC -a MC_XS -a MC_TAUS -a MC_PHOTONS -a MC_JETS -a MC_ELECTRONS -a CMS_2017_I1635889 -a CMS_2018_I1667854 -a CMS_2019_I1753680 -a CMS_2020_I1837084 -o dyee012j_5f_NLO_UNLOPS15.yoda &>> rivet15.log
