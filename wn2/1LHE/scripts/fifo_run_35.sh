...
rm -rf hepmc35.fifo  # delete existing pipes
rm -rf pythia35.log
rm -rf rivet35.log

mkfifo hepmc35.fifo  # initiate pipe

./main89 main89unlops1LHE35.cmnd hepmc35.fifo >> pythia35.log &
...
rivet hepmc35.fifo --event-timeout 172800 -a MC_ZKTSPLITTINGS -a MC_ZJETS -a MC_ZINC -a MC_XS -a MC_TAUS -a MC_PHOTONS -a MC_JETS -a MC_ELECTRONS -a CMS_2017_I1635889 -a CMS_2018_I1667854 -a CMS_2019_I1753680 -a CMS_2020_I1837084 -o dyee012j_5f_NLO_UNLOPS35.yoda &>> rivet35.log
