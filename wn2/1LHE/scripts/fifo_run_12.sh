...
rm -rf hepmc12.fifo  # delete existing pipes
rm -rf pythia12.log
rm -rf rivet12.log

mkfifo hepmc12.fifo  # initiate pipe

./main89 main89unlops1LHE12.cmnd hepmc12.fifo >> pythia12.log &
...
rivet hepmc12.fifo --event-timeout 172800 -a MC_ZKTSPLITTINGS -a MC_ZJETS -a MC_ZINC -a MC_XS -a MC_TAUS -a MC_PHOTONS -a MC_JETS -a MC_ELECTRONS -a CMS_2017_I1635889 -a CMS_2018_I1667854 -a CMS_2019_I1753680 -a CMS_2020_I1837084 -o dyee012j_5f_NLO_UNLOPS12.yoda &>> rivet12.log
