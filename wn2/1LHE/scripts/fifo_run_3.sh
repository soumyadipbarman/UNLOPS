...
rm -rf hepmc3.fifo  # delete existing pipes
rm -rf pythia3.log
rm -rf rivet3.log

mkfifo hepmc3.fifo  # initiate pipe

./main89 main89unlops1LHE3.cmnd hepmc3.fifo >> pythia3.log &
...
rivet hepmc3.fifo --event-timeout 172800 -a MC_ZKTSPLITTINGS -a MC_ZJETS -a MC_ZINC -a MC_XS -a MC_TAUS -a MC_PHOTONS -a MC_JETS -a MC_ELECTRONS -a CMS_2017_I1635889 -a CMS_2018_I1667854 -a CMS_2019_I1753680 -a CMS_2020_I1837084 -o dyee012j_5f_NLO_UNLOPS3.yoda &>> rivet3.log
